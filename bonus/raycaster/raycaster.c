...
/*   Updated: 2025/07/14 17:10:22 by hfalati          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	calc_tex_x(t_game *game)
{
	...
	if (game->ray.side == 0)
		hit_pos = game->player.pos.y + \
			game->ray.perp_wall_dist * game->ray.dir.y;
	else
		hit_pos = game->player.pos.x + \
			game->ray.perp_wall_dist * game->ray.dir.x;
